# JAX Builds on ROCm
This directory contains files and setup instructions to build and test JAX in Docker ROCm environment (runtime and CI). You can build, test and run JAX on ROCm yourself!
***
